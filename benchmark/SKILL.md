...
Write to `.gstackbenchmark-reports/baselines/baseline.json`.
...
Write to `.gstackbenchmark-reports/{date}-benchmark.md` and `.gstackbenchmark-reports/{date}-benchmark.json`.

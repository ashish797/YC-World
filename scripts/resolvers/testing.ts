...
Write to \`~/.openclaw/ycworld/company/projects/{slug}/{user}-{branch}-eng-review-test-plan-{datetime}.md\`:
...
Write to \`~/.openclaw/ycworld/company/projects/{slug}/{user}-{branch}-ship-test-plan-{datetime}.md\`:

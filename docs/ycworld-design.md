# YC World — Workspace Structure (Final v2)

## Company Model

```
CEO (YC Main) ←→ user (the client)
  │
...
│   ├── USER.md                       ← "I serve the CEO (YC Main)"
...
│
└── skills/                           ← 29 gstack-openclaw skills

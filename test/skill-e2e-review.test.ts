...
describeIfSelected('Review Dashboard Via Attribution', ['review-dashboard-via'], () => {
  ...
  beforeAll(() => {
    ...
    // gstack-review-read reads from ~/.openclaw/ycworld/company/projects/$SLUG/$BRANCH-reviews.jsonl
...
Instead of running gstack-openclaw/bin/gstack-review-read, run this mock: ${mockBinDir}/gstack-review-read

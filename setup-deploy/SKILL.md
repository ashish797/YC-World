...
Create or update `gstack-openclaw/data/deploy-config.json` in the project root:

```bash
CONFIG_FILE=".gstack-deploy.json"
...
To change settings later, edit `.gstack-deploy.json` directly or re-run this skill.

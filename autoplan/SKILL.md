...
- Discover design docs: `ls -t gstack-openclaw/data/projects/$SLUG/*-design-*.md 2>/dev/null | head -1`
...
- `gstack-openclawplan-ceo-review/SKILL.md`
- `gstack-openclawplan-design-review/SKILL.md` (only if UI scope detected)
- `gstack-openclawplan-eng-review/SKILL.md`
...
Override: every Ask the user → auto-decide using the 6 principles.

**Override rules:**
- Mode selection: SELECTIVE EXPANSION
- Premises: accept reasonable ones (P6), challenge only clearly wrong ones
- **GATE: Present premises to user for confirmation** — this is the ONE Ask the user
...
- **Premises are the one gate.** The only non-auto-decided Ask the user is the premise confirmation in Phase 1.

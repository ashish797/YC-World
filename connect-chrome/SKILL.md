...
```bash
BROWSE="gstack-openclaw/browse/dist/browse"
$BROWSE connect
```
...
> 2. Look for "gstack browse" — it should be listed
> 3. If not, click "Load unpacked" and point to `gstack-openclaw/browse/extension/`

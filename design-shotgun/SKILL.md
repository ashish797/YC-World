...
**Why /tmp/ then cp?** In observed sessions, `$D generate --output gstack-openclaw/data/...`
...
1. **Never save to `.context/`, `docs/designs/`, or `/tmp/`.** All design artifacts go
   to `gstack-openclaw/data/projects/$SLUG/designs/`. This is enforced. See DESIGN_SETUP above.
